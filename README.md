...
- Some features may have a certain performance impact and should be selectively enabled based on your performance situation, e.g., scroll effect, theme color following time, immersive mode.
